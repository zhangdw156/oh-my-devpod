...
assert_glob "${tmp_dir}/config/nvim.oh-my-devpod.bak.*"
assert_glob "${tmp_dir}/data/nvim.oh-my-devpod.bak.*"
assert_glob "${tmp_dir}/state/nvim.oh-my-devpod.bak.*"
assert_glob "${tmp_dir}/cache/nvim.oh-my-devpod.bak.*"
