...
assert_absent 'HOMEBREW_BREW_GIT_REMOTE' "${switch_home}/.config/oh-my-devpod/env"
assert_absent 'HOMEBREW_BOTTLE_DOMAIN' "${switch_home}/.config/oh-my-devpod/env"
assert_absent 'HOMEBREW_API_DOMAIN' "${switch_home}/.config/oh-my-devpod/env"
assert_absent 'UV_CONFIG_FILE' "${switch_home}/.config/oh-my-devpod/env"
