...
if [[ "${prefix_explicit}" != "1" ]]; then
  if [[ "$mode" == "system" ]]; then
    prefix="${OHMYDEVPOD_PREFIX:-/opt/${flavor_name}}"
  else
    prefix="${OHMYDEVPOD_PREFIX:-${HOME}/.local/${flavor_name}}"
  fi
fi
...
bin_dir="${OHMYDEVPOD_BIN_DIR:-}"
config_home="${OHMYDEVPOD_CONFIG_HOME:-}"
data_home="${OHMYDEVPOD_DATA_HOME:-}"
state_home="${OHMYDEVPOD_STATE_HOME:-}"
cache_home="${OHMYDEVPOD_CACHE_HOME:-}"
...
export OHMYDEVPOD_PREFIX="${prefix}"
export OHMYDEVPOD_FLAVOR="${flavor_name}"
export OHMYDEVPOD_BIN_DIR="${bin_dir}"
export OHMYDEVPOD_CONFIG_DIR="${config_home}"
export OHMYDEVPOD_DATA_HOME="${data_home}"
export OHMYDEVPOD_STATE_HOME="${state_home}"
export OHMYDEVPOD_CACHE_HOME="${cache_home}"
export OHMYDEVPOD_REPO_ROOT="${repo_root}"
export OHMYDEVPOD_VENDOR_HOME="${vendor_home}"
export OHMYDEVPOD_RUNTIME_HOME="${runtime_home}"
export OHMYDEVPOD_RUNTIME_VENDOR_HOME="${runtime_vendor_home}"
export OHMYDEVPOD_SHELL_DIR="${shell_dir}"
export OHMYDEVPOD_CLAUDE_REAL_BIN="${bin_dir}/claude-real"
export OHMYDEVPOD_CODEX_REAL_BIN="${bin_dir}/codex-real"
export OHMYDEVPOD_COPILOT_REAL_BIN="${bin_dir}/copilot-real"
export OHMYDEVPOD_GEMINI_REAL_BIN="${bin_dir}/gemini-real"
export OHMYDEVPOD_HOMEBREW_PREFIX="${homebrew_prefix}"
eval "\$(${homebrew_prefix}/bin/brew shellenv)"
...
export OHMYDEVPOD_BIN_DIR="${bin_dir}"
export OHMYDEVPOD_FLAVOR="${flavor_name}"
export OHMYDEVPOD_LAZYVIM_SOURCE_DIR="${vendor_home}/nvim/lazyvim-starter"
export OHMYDEVPOD_LAZYVIM_STARTER_COMMIT="803bc181d7c0d6d5eeba9274d9be49b287294d99"
export OHMYDEVPOD_NVM_CONFIG_DIR="${xdg_config_home}/nvim"
export OHMYDEVPOD_NVM_DATA_DIR="${xdg_data_home}/nvim"
export OHMYDEVPOD_NVM_STATE_DIR="${xdg_state_home}/nvim"
export OHMYDEVPOD_NVM_CACHE_DIR="${xdg_cache_home}/nvim"
export OHMYDEVPOD_NVM_OVERLAY_DIR="${repo_root}/config/nvim"
export OHMYDEVPOD_PYRIGHT_VERSION="1.1.408"
export OHMYDEVPOD_RUFF_VERSION="0.15.9"
export OHMYDEVPOD_HARLEQUIN_VERSION="2.5.2"
export OHMYDEVPOD_UV_BIN="${homebrew_prefix}/bin/uv"
export OHMYDEVPOD_UV_TOOL_DIR="${prefix}/opt/uv-tools"
export OHMYDEVPOD_REPO_ROOT="${repo_root}"
export OHMYDEVPOD_VENDOR_HOME="${vendor_home}"
export OHMYDEVPOD_RUNTIME_HOME="${runtime_home}"
export OHMYDEVPOD_RUNTIME_VENDOR_HOME="${runtime_vendor_home}"
export OHMYDEVPOD_CONFIG_HOME="${config_home}"
export OHMYDEVPOD_PREFIX="${prefix}"
export OHMYDEVPOD_SHELL_DIR="${shell_dir}"
