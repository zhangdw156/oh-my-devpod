...
cp "${repo_root}/build/install-gitee-cli.sh" "${bundle_root}/build/install-gitee-cli.sh"
cp "${repo_root}/build/install-lazyvim.sh" "${bundle_root}/build/install-lazyvim.sh"
cp "${repo_root}/build/omd-brew-gateway.sh" "${bundle_root}/build/omd-brew-gateway.sh"
cp "${repo_root}/build/omd-brew-provisioner.sh" "${bundle_root}/build/omd-brew-provisioner.sh"
